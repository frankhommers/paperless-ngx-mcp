    ...
    "update_tag",
    {
      ...
      inputSchema: z.object({
        id: z
          .number()
          .describe(
            "ID of the tag to update. Use list_tags to find existing tag IDs.",
          ),
        name: z
          .string()
        ...
        permissions: z
          .object({
            view: z
              ...
              .describe(
                "Users and groups with view/use permissions for these tags",
              ),
            change: z
              .object({
                users: z
              ...
              .describe(
                "Users and groups with edit permissions for these tags",
              ),
          })
          .optional()
          .describe(
